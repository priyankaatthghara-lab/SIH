...
const s = {
  ...
  row1: { display: "flex", flexWrap: "wrap", gap: 20 },
  profileCard: {
    flex: "1 1 280px",
  ...
  profileTop:  { display: "flex", gap: 14, position: "relative", alignItems: "flex-start", flexWrap: "wrap" },
  ...
  table:    { width: "100%", borderCollapse: "collapse", marginTop: 20, display: "block", overflowX: "auto", whiteSpace: "nowrap" },
